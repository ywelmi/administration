...
import { liveProductTableBodyData } from "../../../../Data/dashboard";
        ...
        <tr key={i}>
          <td>
            <div className="product-name">
              <Image
                className="order-table-images img-fluid"
                src={dynamicImage(`dashboard/order-table/${data.image}`)}
                alt="user"
              />
