        ...
        <LI className="d-flex top-product gap-2" key={i}>
          <div>
            <Image
              ...
              src={dynamicImage(`dashboard-3/product/${data.image}`)}
              alt="product"
            />
          </div>
          <div className="w-100 d-flex justify-content-between align-items-center">
            <div className="product-details">
              <div>
                <Badges pill color="light" className="text-dark">
                  {data.badge}
                </Badges>
              </div>
              <Link
                className="f-10 f-w-500  line-clamp"
            ...
            <div className="product-items">
              {data.quantity.map((item, i) => (
                <div className="common-space gap-1" key={i}>
                  <span className="f-10 f-w-500 f-light">
                    {item.subTitle} :
                  </span>
