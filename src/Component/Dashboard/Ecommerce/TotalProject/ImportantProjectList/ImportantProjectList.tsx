...
const ImportantProjectList = () => {
  return (
    <Col xl="12">
      <Card>
        <CardHeaderCommon
          title={ImportantProjectListHeading}
          subTitle="View All"
        />
        <CardBody className="pt-0 row important-project">
          {importantProjectListData.map((data, i) => (
            <Col
              xl="4"
              md="6"
              className={`${data.class ? data.class : "box-col-6 "}`}
              key={i}
            >
                ...
                <div className="projectlist">
                  <div className="project-data">
                    <Image
                      ...
                      src={dynamicImage(`dashboard-2/category/${data.image}`)}
                      alt="nft"
                    />
                    <div>
                      <Link
                        className="f-14 f-w-500 d-block"
