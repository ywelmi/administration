              ...
              {activityLogCardData.map((data, i) => (
                <LI className="activity-log" key={i}>
                  <div className="d-flex align-items-start gap-2">
                    <Image
                      className="activity-log-img rounded-circle img-fluid me-2"
                    ...
                    <div>
                      ...
                      <div className="d-flex mb-2">
                        ...
                        <Link className="f-w-500 f-12" to={Href}>
                          {data.apps}
                        </Link>
                      </div>
                      <span className="f-light f-w-500 f-12 d-block">
                        {data.comment}
                      </span>
