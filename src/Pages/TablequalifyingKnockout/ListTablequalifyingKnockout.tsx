...
import { TablequalifyingKnockoutMatchReportModal, useTablequalifyingKnockout } from "./TablequalifyingKnockoutForm";
...
const CustomSeed = ({
    ...
    const { fetchTablequalifyingKnockout, sportId, knockoutTeams } = useKnockoutContext();
    ...
    const [lockPick, setLockPick] = useState(seed.teams[0]?.id && seed.teams[1]?.id);
    ...
    const handleUpdateKnockoutMatch = (v: TTablequalifyingKnockoutMatchReport) => {
                ...
                <div>
                    {roundIndex == 0 && !lockPick ? (
                        ...
                        <SeedTeam className="team">
                            {pair.team1_name ? `${pair.team1_name}: ${pair.team1_point_win_count || ""}` : "NO TEAM"}
                        </SeedTeam>
                    )}
                    <div className="p-2">
                        {isFilledPair ? (
                    ...
                    {roundIndex == 0 && !lockPick ? (
                        ...
                        <SeedTeam className="team">
                            {pair.team2_name ? `${pair.team2_name}: ${pair.team2_point_win_count || ""}` : "NO TEAM"}
                        </SeedTeam>
                    )}
                </div>
            </SeedItem>
...
const PageTablequalifyingKnockout = () => {
    ...
    const handleAddKnockoutBracket = useCallback((knockoutBracket: IKnockoutCreate) => {
    ...
    const { handleToggle: handleToggleAddModal, TablequalifyingKnockoutModal: TablequalifyingKnockoutAddModal } =
                    ...
                    <Col sm="12">
                        <Card>
                            <CardHeader className="pb-0 card-no-border">
                                ...
                                />
                                <div ref={addBtnRef} className="btn btn-primary" onClick={handleToggleAddModal}>
