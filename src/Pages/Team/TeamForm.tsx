        ...
        <form onSubmit={formik.handleSubmit}>
          ...
          <Col md="12" className="d-none">
            ...
            />
                ...
                {formik.errors.org_id ? <div className="invalid-input">{formik.errors.org_id}</div> : null}
                {orgs?.length ? (
                    <Col md="12">
                        <InputSelect
                            title={t("org_id")}
                ...
                {formik.errors.sport_id ? <div className="invalid-input">{formik.errors.sport_id}</div> : null}
                {sports?.length ? (
                    <Col md="12">
                        <InputSelect
                            title={t("sport_id")}
                ...
                <Col md="12" className="form-check checkbox-primary">
                    ...
                    <ListTeammember
                        ...
                        enableRowSelection={(r) => {
                            ...
                            return r.original?.sport_id && r.original.sport_id !== formik.values.sport_id
                                ? false
                                : true;
                        }}
                    />
