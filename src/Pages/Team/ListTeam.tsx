...
interface IListTeam {
    ...
    onSelectedRowsChange?: (v: { allSelected: boolean; selectedCount: number; selectedRows: TTeam[] }) => void;
...
const tableColumns = (
    ["competition_name", "org_name", "sport_name", "list_member_name"] as (keyof Omit<
        TTeamColumn,
        "list_team_member"
    >)[]
).map((c) => ({
