          ...
          <Row>
            ...
            <Col md="9">
              <Input
                ...
                onChange={(date) =>
                  formik.setFieldValue("date_of_issue", date.target.value)
                }
              />
            </Col>
          </Row>
          ...
          <Row>
            ...
            <Col md="9">
              <Input
                ...
                defaultValue={
                  formik.values.dob
                    ? convertToDateType2(formik.values.dob)
                    : undefined
                }
                onChange={(date) =>
                  formik.setFieldValue("dob", date.target.value)
                }
              />
            </Col>
          </Row>
          ...
          <Row>
            ...
            <Col md="9">
              <Input
                ...
                onChange={(date) =>
                  formik.setFieldValue("date_join_army", date.target.value)
                }
              />
            </Col>
          </Row>
