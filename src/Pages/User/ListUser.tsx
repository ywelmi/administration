...
interface IListUser {
    ...
    onSelectedRowsChange?: (v: { allSelected: boolean; selectedCount: number; selectedRows: TUser[] }) => void;
...
const userAction: ColumnDef<TUser> = {
    ...
    cell(props) {
        ...
        const { handleToggle: handleToggleUpdateModal, UserModal: UserUpdateModal } = useUserModal({
...
const PageUser = () => {
    ...
    const { handleToggle: handleToggleAddModal, UserModal: UserAddModal } = useUserModal({ onSubmit: handleAddUser });
                        ...
                        <Card>
                            ...
                            <CardBody>
                                <ListUser
                                    ...
                                    selectableRowSelected={(row) => row.fullname.includes("admin")}
                                />
                            </CardBody>
                        </Card>
                    </Col>
