...
interface IListMartialArt {
    ...
    data?: TMartialArt[];
    onRowSelect?: (row: TMartialArt, e: React.MouseEvent<Element, MouseEvent>) => void;
    onSelectedRowsChange?: (v: { allSelected: boolean; selectedCount: number; selectedRows: TMartialArt[] }) => void;
        ...
        return (
            <UL className="action simple-list flex-row" id={martialArtContent.id}>
                ...
                <LI
                    className="edit btn"
                    onClick={() => {
                        navigate(`/martialart/${martialArtContent.sport_id}/knockout/${martialArtContent.id}`);
                    }}
                >
...
const PageMartialArt = () => {
    ...
    return (
        <div className="page-body">
            <Breadcrumbs mainTitle={"Võ chiến đấu"} parent={"Lực lượng thường trực"} />
            <Container fluid>
                <Row>
                    <Col sm="12">
                        <Card>
                            <CardHeader className="pb-0 card-no-border">
                                ...
                                <div className="btn btn-success" onClick={handleDownload}>
                                    <i className="fa fa-plus" />
