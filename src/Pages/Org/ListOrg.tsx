...
const OrgTableAction = ({ org }: { org: TOrgColumn }) => {
    ...
    const { handleToggle: handleToggleUpdateModal, OrgModal: OrgUpdateModal } = useOrgModal({
...
const ListOrg = () => {
    ...
    const { handleToggle: handleToggleAddModal, OrgModal: OrgAddModal } = useOrgModal({ onSubmit: handleAddOrg });
