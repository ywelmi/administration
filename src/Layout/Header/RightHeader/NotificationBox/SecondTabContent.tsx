    ...
    <div className="notification-card">
      <UL>
        {messageData.map((data, i) => (
          <LI
            className="notification d-flex w-100 justify-content-between align-items-center"
            key={i}
          >
            <div className="d-flex w-100 notification-data justify-content-center align-items-center gap-2">
              <div className="user-alerts flex-shrink-0">
                <Image
                  className="rounded-circle img-fluid img-40"
              ...
              <div className="flex-grow-1">
                <div className="common-space user-id w-100">
                  <div className="common-space w-100">
                    <Link
                      className="f-w-500 f-12"
                      to={`${import.meta.env.VITE_PUBLIC_URL}/chat/privatechats`}
                    >
                      {data.name}
                    </Link>
                  </div>
